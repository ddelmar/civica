...
<div class="container">
        <section class="row-fluid">
            <div class="span10 offset1">
                ...
                <h1>Software for public good</h1>
            </div>
        </section>
    </div>
    ...
    <div class="navbar-inner">
        <div class="container">
	        ...
	        <div class="nav-collapse collapse" id="nav-main">
                <ul id="nav" class="nav nav-pills"><li class="active menu-home"><a href="/#MainHeader">Home</a></li>
	<li class="active menu-work"><a href="/#about">About</a></li>
<li class="active menu-work"><a href="/#works">Products</a></li>
<li class="active menu-info"><a href="/#contact">Contact</a></li>
</ul>            </div>
        </div>
    </div>
</nav>
...
jQuery(window).load(function () {
                    /* parallax effect */
		            jQuery("#MainHeader").parallax("20%", 0.2, true);
				});
...
jQuery(window).load(function () {
                    /* parallax effect */
		            jQuery("#works").parallax("20%", 0.2, true);
				});
				jQuery(window).resize(function () {
				    setTimeout(function () {
				        jQuery("#works").parallax("20%", 0.2, true);
...
jQuery(window).load(function () {
                    /* parallax effect */
		            jQuery("#info").parallax("20%", 0.2, true);
				});
				jQuery(window).resize(function () {
				    setTimeout(function () {
				        jQuery("#info").parallax("20%", 0.2, true);
...
jQuery(window).load(function () {
                    /* parallax effect */
		            jQuery("#blog").parallax("20%", 0.2, true);
				});
				jQuery(window).resize(function () {
				    setTimeout(function () {
				        jQuery("#blog").parallax("20%", 0.2, true);
...
jQuery(window).load(function () {
                    /* parallax effect */
		            jQuery("#contact").parallax("20%", 0.2, true);
				});
				jQuery(window).resize(function () {
				    setTimeout(function () {
				        jQuery("#contact").parallax("20%", 0.2, true);
...
function carouselFlexsliderInit() {
		    jQuery(".flexCarousel .flexslider").flexslider({
		        ...
		        animationLoop: true,
		        slideshow: false,
		        itemWidth: 216,                   //{NEW} Integer: Box-model width of individual carousel items, including horizontal borders and padding.
