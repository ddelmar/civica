...
class MultipleSidebarsCore {
	...
	function MS_view_sidebars($sidebars,$opcion=""){
		...
		$id_sidebar = "sidebar-primary";
		if (preg_match("#^" . $id_sidebar . "|\," . $id_sidebar . "\,|" . $id_sidebar . "$#", $sidebars)) {
			$a = explode(",", $sidebars);
			for ($i = 0; $i < count($a); $i++) {
				if ($a[$i] == $id_sidebar) {
					$activos[$i] = '<div id="sidebar-primary">Default<a href="javascript:return false;" class="agregar"></a><a href="javascript:return false;" class="borrar"></a><a href="javascript:return false;" class="arriba"><a href="javascript:return false;" class="abajo"></a></div>';
				}
			}
			//$activos .= ;
			//$todos .= "<input checked='checked' type='checkbox' name='sidebars[]' value='multiple-sidebars-default' />";
		} else {
			$inactivos .= '<div id="sidebar-primary">Default<a href="javascript:return false;" class="agregar"></a><a href="javascript:return false;" class="borrar"></a><a href="javascript:return false;" class="arriba"><a href="javascript:return false;" class="abajo"></a></div>';
